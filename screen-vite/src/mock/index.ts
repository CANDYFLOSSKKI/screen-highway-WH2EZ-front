import {
    ...
    DeviceData,
    EventData,
    RealTimeCarData, SecInfoElem, SectionData, SectionEntity, SecTimeRangeElem,
    SpecificCarData
...
export default [
    ...
    },
    {
        ...
        method: 'get',
        // @ts-ignore
        response: ({query}):EventData => {
            return {
                count: 2,
                entities: [
                    {eventType: '超速', id: '鄂AS858E', location: 'K4+520', time: '2022-10-09|11:14:45', trajId: 1665280800001,},
                    {eventType: '跟车过近', id: '鄂A9T97W', location: 'K11+880', time: '2022-10-09|11:01:29', trajId: 1665280800002,},
                    {eventType: '违停', id: '鄂GT0673', location: 'K11+574', time: '2022-10-09|09:58:16', trajId: 1665280800003,},
                    {eventType: '低速', id: '鄂AS858E', location: 'K9+230', time: '2022-10-09|09:45:39', trajId: 1665280800004,},
                    {eventType: '低速', id: '鄂JFG506', location: 'K8+893', time: '2022-10-09|08:26:43', trajId: 1665280800005,},
                    {eventType: '危险变道', id: '鄂A9T97W', location: 'K7+219', time: '2022-10-09|08:19:45', trajId: 1665280800002,},
                ],
                day: '2022-10-09',
            }
        }
    ...
    },
    {
        ...
        response: ({query}): SpecificCarData => {
            return {
                count: 3,
                entities: [
                    {carNumber: "鄂AS858E", trajId: 1665280800001, angle: 73.4444, location: "K2+750", position: [114.9861699, 30.2998329], speed: 148, direction: 2},
                    {carNumber: "鄂AS858E", trajId: 1665280800001, angle: 73.4444, location: "K3+750", position: [114.9863846, 30.2999221], speed: 145, direction: 2},
                    {carNumber: "鄂AS858E", trajId: 1665280800001, angle: 73.4444, location: "K4+300", position: [114.9862929, 30.2998783], speed: 145, direction: 2},
                    {carNumber: "鄂AS858E", trajId: 1665280800001, angle: 73.4444, location: "K4+520", position: [114.9862929, 30.2998783], speed: 147, direction: 2},
                    {carNumber: "鄂AS858E", trajId: 1665280800001, angle: 73.4444, location: "K4+750", position: [114.9862929, 30.2998783], speed: 150, direction: 2},
                ],
                timeStart: "2022-10-09|10:00:00",
                timeEnd: "2022-10-09|10:02:00",
            }
...
const secTodayQueryMockData:Array<SectionEntity> = [
...
const secLastedQueryMockData:Array<SectionEntity> = [
