...
export const useSectionStore = defineStore('section',() => {
     ...
     * @param time 指定时间段
     */
    async function getTodaySecData(time:number):Promise<SectionData|undefined> {
        let data = undefined;
        await getTodaySecDataAPI(time).then((res) => {
            data = res as SectionData;
        }).catch((err) => {
            httpErrorOutput(err as HttpErrorData);
        })
     ...
     * @param time 指定时间段
     */
    async function getSpecificDaySecData(date:string, time:number):Promise<SectionData|undefined> {
        let data = undefined;
     ...
     */
    async function getLastedSecData():Promise<SectionData|undefined> {
        let data = undefined;
