...
import {postureSectionSpeedByPositionData} from "@/static/data/posture.ts";

export const postureSectionSpeedByPositionOptions:any = {
    grid: {
        top: '25%',
        bottom: '15%',
        left: '10%',
    ...
    dataset: {
        source: [
            ...
            ...postureSectionSpeedByPositionData,
        ]
    },
    xAxis: {
        type: 'category',
