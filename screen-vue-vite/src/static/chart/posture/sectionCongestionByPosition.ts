...
import {postureSectionCongestionByPositionData} from "@/static/data/posture.ts";

export const postureSectionCongestionByPositionOptions:any = {
    grid: {
        top: '25%',
        bottom: '15%',
        left: '10%',
    ...
    dataset: {
        source: [
            ...
            ...postureSectionCongestionByPositionData,
        ]
    },
    xAxis: {
        type: 'category',
